...
import ICreateAppointimentDTO from '@modules/appointments/dtos/ICreateAppointmentDTO';
...
class AppointmentsRepository implements IAppointmentsRepository {
  ...
  public async create({ user_id, provider_id, date }: ICreateAppointimentDTO): Promise<Appointment> {
